...
const StatsCamera = () => {
  const [imageUri, setImageUri] = useState('http://192.168.137.14:5000/image_model1'); // 초기값으로 유효한 URL 설정
  ...
  //     setNextImageUri(`http://192.168.137.14:5000/image_model1?${timestamp}`); // 캐시 방지용 타임스탬프 추가
  //   }, 500); // 500ms마다 이미지 갱신
